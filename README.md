...
- 📚 **87 уроков** — от основ до веб-разработки
- 🎯 **435 практических заданий** с автоматической проверкой
...
### Раздел 2: Веб-разработка на Go (13 уроков)
...
### Импорт/обновление уроков из markdown

```bash
# Импортировать все уроки
go run ./cmd/ingest --db ./data.db

# Импортировать только первые N уроков
