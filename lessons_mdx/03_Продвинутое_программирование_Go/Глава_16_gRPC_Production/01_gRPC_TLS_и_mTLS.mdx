...
<Task id="1" points="15">
<Title>Задание 1: Включите TLS в capstone gRPC</Title>
<Prompt>
Добавьте TLS на gRPC сервер и клиент. Проверьте, что вызовы работают и не используется insecure в staging/CI.
</Prompt>
<StarterCode>
```go
package main
...
<Task id="2" points="15">
<Title>Задание 2: Добавьте mTLS</Title>
<Prompt>
Настройте mTLS: сервер требует клиентский сертификат и проверяет его по CA. На клиенте используйте `client.crt/client.key`.
</Prompt>
<StarterCode>
```go
package main
