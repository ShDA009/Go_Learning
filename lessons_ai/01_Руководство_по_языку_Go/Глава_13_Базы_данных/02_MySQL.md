...
### Задача 2: User registration
Регистрация с проверкой уникальности email.

### Задача 3: Order system
Система заказов с транзакциями.

### Задача 4: Search
Поиск товаров по названию (LIKE).

### Задача 5: Pagination
Постраничный вывод с LIMIT/OFFSET.

### Задача 6: Statistics
Агрегатные функции (COUNT, SUM, AVG).

### Задача 7: Relations
JOIN запросы для связанных таблиц.

### Задача 8: Bulk operations
Массовые операции вставки/обновления.
