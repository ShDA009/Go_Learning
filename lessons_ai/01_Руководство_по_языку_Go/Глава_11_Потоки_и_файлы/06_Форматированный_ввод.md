...
Прочитайте два числа и операцию, выведите результат.

### Задача 2: Парсер координат
Прочитайте координаты в формате "(x, y)".

### Задача 3: Лог-парсер
Распарсите лог-файл с timestamps и сообщениями.

### Задача 4: INI парсер
Прочитайте конфигурационный файл в формате INI.

### Задача 5: Матрица
Прочитайте матрицу чисел из файла.

### Задача 6: Статистика
Прочитайте числа из файла и вычислите min, max, avg.

### Задача 7: Адресная книга
Прочитайте и обработайте файл с контактами.

### Задача 8: Валидация
Прочитайте данные и проверьте их корректность.
